...
您可以访问 [这里](/icebox_latest.apk) 下载最新版本 APK

可在冰箱「设置 - 关于」界面看到具体的版本和渠道信息。不同渠道包的内容是一样的

注：以上列出的均为**分发渠道**，不是**支付渠道**。支付渠道取决于安装方式，从 Play Store 下载安装的，使用 Google 支付和验证；其他所有方式安装的，都使用支付宝或[其他支付方式](/%E5%85%B6%E4%BB%96%E6%94%AF%E4%BB%98%E6%96%B9%E5%BC%8F)

### 更新日志
3.30.11
- 修复可折叠设备 UI 适配问题
- 适配小米读取 app 列表权限
- 无线调试第二次配对开始不再强制要求关闭 VPN
...
3.30.8
- 启动无线调试的说明中新增视频操作教程
- 修复部分设备上「冰箱正在请求启动 xxx」 权限弹框频繁出现的问题
...
- 更新 Shizuku，支持 Sui
- 图标支持 monochrome
- 对 Android S 开始启用动态取色界面，增加模糊背景效果
- 日夜间模式支持跟随系统
- 国内版支持微信支付
- 修复了一些布局错位
- 同步 Google Play 要求，移除了提权插件

3.22.0
- 根据 Google Play Protect Team 的强制要求，「提权插件」模式已移除。如需要此功能请在互联网上搜索下载旧版安装
- 新功能：日夜间主题支持随系统自动切换

3.21.0
- 修复 Shizuku 模式下的部分功能问题
- 根据支付宝要求，更新了 SDK
- 其他问题修复

3.20.0
- 修复滑稽订单号无法激活的问题
- 尝试修复 MIUI 等部分 ROM 上设置了冰箱为管理员后无法使用自带双开的问题，待测试
- 密码锁解锁时支持调用人脸识别

3.19.0
- 新增选项：冻结按钮中置
- 使用微软 AppCenter 替换即将倒闭的 Fabric
- 部分问题修复
...
- 更新了国内使用的服务器，增强了稳定性，建议国内用户更新. 国外用户不受影响.
- 其他 bug 修复和性能提升. 
